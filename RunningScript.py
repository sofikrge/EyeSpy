...
def main():
    ...
    qc_df = prep.filter_events_blink_spatial(
        dataset=settings.dataset,
        raw_data_dir=settings.RAW_DATA_DIR,
        buffer_fix=settings.BUFFER_FIX,
        buffer_sac=settings.BUFFER_SAC,
        hx=settings.HX,
        hy=settings.HY,
    ...
    prep.assign_trial_metadata_and_phases(
        dataset=settings.dataset,
        raw_data_dir=settings.RAW_DATA_DIR,
        behavioural_dir=settings.BEHAVIOURAL_DIR,
        events_out_dir=settings.EVENTS_OUT_DIR,
